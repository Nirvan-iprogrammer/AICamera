...
const Intrusion  = () => {
  ...
  const noOfPage = Math.floor(intrusion.length / noPerPage);
  ...
  const displayItems = intrusion.slice(firstIndexPage, lastIndexPage);
...
//         setActveTab(data.services[0].Day);
//       } catch (error) {
...
//     setActiveIndex(index);
//     setActveTab(user);
//     console.log("dispatch(setItemEvent(userData))", index, user[0].Images)
//     dispatch(setItemEvent(user[0].Images))
//   };

//   const showDetails = (userData) => {
//     console.log("userData", userData)
//     dispatch(setItemEvent(userData))
//     navigate("/event")
//     // navigate("/event",{ state: { from: 'services', items: userData } })
//   }
